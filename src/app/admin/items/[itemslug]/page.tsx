...
const Page = async ({ params }: { params: { itemslug: string } }) => {
  ...
  console.log(itemDetails.auctions)
      ...
      <section className="px-2 lg:px-10 my-4">
        ...
        <div className="w-full my-4 lg:my-6 ">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white relative p-4 flex flex-col items-center justify-center rounded-xl shadow-md shadow-slate-300">
              <ImageWrapper
                src={itemImage}
            ...
            <div className="bg-white p-2 rounded-xl shadow-md shadow-slate-300">
          ...
          <div className="bg-white my-8 p-2 rounded-xl shadow-md shadow-slate-300 h-[45vh] lg:h-[30vh] overflow-y-auto">
            ...
            <ul className="my-4">
              {itemDetails.auctions.map((auction: any) => (
                <Link href={`/auctions/${auction.id}`} key={auction.id}>
                  <li className="border-b rounded-md p-2 my-2 flex justify-between items-center gap-2">
                    <p className="">
          ...
          <div className="bg-white p-8 rounded-xl shadow-md shadow-slate-300">
            <h5 className="tracking-tight text-lg font-medium">Information</h5>
